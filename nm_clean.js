...
const regexf = /(LICENSE|Makefile|tests?|__tests?__|AUTHORS?|karma.conf.js|jest.config.js|bower.json|yarn-error.log)$/i
const regexe = /\.((bash|eslint|vim|jshint|nvm|prettier)rc|(eslint|npm)ignore|editorconfig|md|ya?ml|markdown|eslintrc.json|circleci|grunt|eslintcache|flowconfig)$/i
